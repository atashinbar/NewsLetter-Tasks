	...
	*/
	...
	function create_field( $field )
	{
		...
		<div id="wp-<?php echo $id; ?>-wrap" class="acf_wysiwyg wp-editor-wrap" data-toolbar="<?php echo $field['toolbar']; ?>" data-upload="<?php echo $field['media_upload']; ?>">
			...
			$the_editor = apply_filters( 'the_editor', '<div id="wp-' . $id . '-editor-container" class="wp-editor-container">' .
            	'<textarea id="' . $id . '" class="wp-editor-area" name="' . $field['name'] . '">%s</textarea></div>' );
