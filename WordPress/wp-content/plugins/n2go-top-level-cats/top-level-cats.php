<?php
/*
Plugin Name: N2GO - FV Top Level Categories
...
// Changes
// 1. Added blog/ prefix to rewrites
// $category_rewrite['blog/('.$category_nicename.')/(?:feed/)?(feed|rdf|rss|rss2|atom)/?$'] = 'index.php?category_name=$matches[1]&feed=$matches[2]';
// $category_rewrite['blog/('.$category_nicename.')/page/?([0-9]{1,})/?$'] = 'index.php?category_name=$matches[1]&paged=$matches[2]';
// $category_rewrite['blog/('.$category_nicename.')/?$'] = 'index.php?category_name=$matches[1]';
