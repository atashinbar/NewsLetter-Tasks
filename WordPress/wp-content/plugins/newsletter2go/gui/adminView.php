    ...
    <form action="admin.php?page=n2go-api" method="POST">
        <div>
            ...
            <div class="n2go-container" style="width: 600px;">
                ...
                <input type="text" name="apiKey" placeholder="Insert your Newsletter2Go API key" value="<?php echo $apiKey; ?>" style="width:300px" />
        ...
        <div>
            ...
            <div class="n2go-container" style="width: 600px;">
                ...
                <?php } ?>
                <input type="text" name="doiCode" placeholder="Insert your Newsletter2Go DOI Code" value="<?php echo $doiCode; ?>" style="width:300px" />
                <input type="submit" value="Save" class="button button-primary btn-nl2go"/>
                <br />
                <a href="https://www.newsletter2go.de/hilfe/empfaenger-verwalten/wo-kann-ich-double-op-in-einstellen/" target="_blank">Where can I find the double opt in code?</a>
            </div>
            <hr />
        </div>
        <div>
                ...
                <ul id="widgetFields">
                    ...
                    foreach ($attributes as $value) {
                        ...
                        <li class="widgetField" draggable="true">
                            <input type="checkbox" <?= $value['disabled']; ?> id="<?= $value['id']; ?>" name="attributes[]" title="<?= $value['title']; ?>" class="js-n2go-widget-field" 
            ...
            <div class="n2go-container" style="width:600px;">
                ...
                <input type="text" id="failureSubsc" name="failureSubsc" value="<?= $texts['failureSubsc']; ?>" size="75" />

                <label for="failureEmail">Failure (wrong email syntax)</label>
                <input type="text" id="failureEmail" name="failureEmail" value="<?= $texts['failureEmail']; ?>" size="75" />

                <label for="failureRequired">Failure (required fields)</label>
                <input type="text" id="failureRequired" name="failureRequired" value="<?= $texts['failureRequired']; ?>" size="75" />

                <label for="failureError">Failure (general error)</label>
                <input type="text" id="failureError" name="failureError" value="<?= $texts['failureError']; ?>" size="75" />

                <label for="buttonText">Text on button</label>
                <input class="js-n2go-widget-field" type="text" id="buttonText" name="buttonText" value="<?= $texts['buttonText']; ?>" size="75" />
                <br/>
                <br/>
                <input type="submit" value="Save" class="button button-primary btn-nl2go"/>
            </div>
            ...
            <div class="n2go-container">
                <div style="width: 600px;float:left;" valign="top">
                    ...
                    <table>
                        <tr>
                            <th>Text color</th>
                            <td><input class="js-n2go-widget-field color-picker" type="text" name="textColor" value="<?= $colors['textColor']; ?>" size="7" /></td>
                        </tr>
                        <tr>
                            <th>Input border color</th>
                            <td><input class="js-n2go-widget-field color-picker" type="text" name="borderColor" value="<?= $colors['borderColor']; ?>" size="7" /></td>
                        </tr>
                        <tr>
                            <th>Input background color</th>
                            <td><input class="js-n2go-widget-field color-picker" type="text" name="backgroundColor" value="<?= $colors['backgroundColor']; ?>" size="7" /></td>
                        </tr>
                        <tr>
                            <th>Button text color</th>
                            <td><input class="js-n2go-widget-field color-picker" type="text" name="btnTextColor" value="<?= $colors['btnTextColor']; ?>" size="7" /></td>
                        </tr>
                        <tr>
                            <th>Button background color</th>
                            <td><input class="js-n2go-widget-field color-picker" type="text" name="btnBackgroundColor" value="<?= $colors['btnBackgroundColor']; ?>" size="7" /></td>
                        </tr>
                    </table>
                ...
                <div id="n2goWidget">
                    ...
                    <div class="preview-pane">
                        <iframe id="widgetPreview" style="width: 100%" src="<?= $previewUrl . urlencode($widget) ?>"></iframe>
                    ...
                    <input type="submit" value="Save subscription form" class="button button-primary btn-nl2go" name="saveApiKey" />
                </div>
            </div>
        </div>
    </form>
                ...
                if (!sourceCode) {
                    ...
                    for (i = 0; i < fields.length; i++) {
                        if (fields[i]['name'] === 'Gender') {
                            sourceCode += '\n    ' + fields[i]['name'] + '<br />\n    ' + '<select ' + inputStyle + 'name="' + fields[i]['id'] + '" required>';
                            sourceCode += '\n      <option value=" "></option>';
                            sourceCode += '\n      <option value="m">Male</option>';
                            sourceCode += '\n      <option value="f">Female</option>';
                            sourceCode += '\n    </select><br>';
                        } else {
                            sourceCode += '\n    ' + fields[i]['name'] + '<br />\n    ' + '<input ' + inputStyle + 'type="text" name="' + fields[i]['id'] + '" required /><br />';
                        }
                    }
