...
$element = 'n2go_page_tabs';

// Extract tab titles
preg_match_all( '/n2go_page_tab([^\]]+)/i', $content, $matches, PREG_OFFSET_CAPTURE );
$tab_titles = array();
/**
 * n2go_page_tabs
 *
...
$output .= "\n\t\t" . '<div class="wpb_wrapper wpb_page_tabs_wrapper ui-tabs vc_clearfix">';
