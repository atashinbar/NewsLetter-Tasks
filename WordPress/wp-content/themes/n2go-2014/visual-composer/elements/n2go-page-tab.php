<?php
define( 'N2GO_PAGE_TAB_TITLE', __( "Tab", "js_composer" ) );
require_once vc_path_dir('SHORTCODES_DIR', 'vc-column.php');

class WPBakeryShortCode_N2Go_Page_Tab extends WPBakeryShortCode_VC_Column {
	protected $controls_css_settings = 'tc vc_control-container';
	protected $controls_list = array('add', 'edit', 'clone', 'delete');
	protected $predefined_atts = array(
		'tab_id' => N2GO_PAGE_TAB_TITLE,
		'title' => ''
	);
...
function n2go_page_tab_id_settings_field( $settings, $value ) {
...
add_shortcode_param( 'n2go_page_tab_id', 'n2go_page_tab_id_settings_field' );